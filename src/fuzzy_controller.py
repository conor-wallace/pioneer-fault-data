...
rule1 = ctrl.Rule(tire_pressure['left flat'], orientation_error['left'])
rule2 = ctrl.Rule(tire_pressure['right flat'], orientation_error['center'])
rule3 = ctrl.Rule(tire_pressure['full'], orientation_error['right'])
...
orientation.input['tire_pressure'] = 0
# Crunch the numbers
orientation.compute()
